...
export class MapSectionComponent implements AfterViewInit {
  ...
  regions = [
    ...
    { id: 2, name: 'Europe',    flag: '🇪🇺', x: 44, y: 28,
    ...
    { id: 3, name: 'Thailand',  flag: '🇹🇭', x: 72, y: 48,
    ...
    { id: 4, name: 'Singapore', flag: '🇸🇬', x: 75, y: 54,
    ...
    { id: 6, name: 'Maldives',  flag: '🇲🇻', x: 62, y: 56,
    ...
    { id: 7, name: 'Australia', flag: '🇦🇺', x: 82, y: 70,
